...
const SERVER_PORT = (module.exports = 3000);
...
const options = {
  key: fs.readFileSync('/etc/letsencrypt/live/dealregal.com/privkey.pem'),
  cert: fs.readFileSync('/etc/letsencrypt/live/dealregal.com/fullchain.pem')
};
